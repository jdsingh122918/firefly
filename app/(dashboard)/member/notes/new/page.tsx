...
export default async function MemberCreateNotePage() {
  ...
  return <NoteCreationPage userRole={UserRole.MEMBER} />
}

export const metadata = {
  title: 'Create Note | Firefly Member',
  description: 'Create a new note with attachments',
}