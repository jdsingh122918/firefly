...
/**
 * Healthcare Tag Selection Page
 *
 * Dedicated full-page interface for browsing and selecting healthcare tags:
 * - Comprehensive category-based organization
 * - Advanced search and filtering capabilities
 * - Spacious layout for better tag discovery
...
export default async function HealthcareTagsPage({
  searchParams
}: {
  ...
  if (!finalUserRole || !['ADMIN', 'VOLUNTEER', 'MEMBER'].includes(finalUserRole)) {
  ...
  const returnUrl = searchParams.returnUrl || '/admin/content/new';
